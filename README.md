...
| [567. Permutation in String](https://leetcode.com/problems/permutation-in-string/) | _O(n)_ | _O(1)_	| Medium | sliding Window(长度为len(s1)), 每次移动框,vector减去新来的，加上刚刚pass的，知道l长度为0 |
