...
| [523. Continuous Subarray Sum](https://leetcode.com/problems/continuous-subarray-sum/) | _O(n)_ | _O(k)_	| Medium | one pass解: 两个hashset, lookup 和res, 找的时候既向上数又向下数, 为了避免重复, set(res)只push下限,结果就是res size |
