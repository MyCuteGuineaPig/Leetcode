...
| [084. Largest Rectangle in Histogram](https://leetcode.com/problems/largest-rectangle-in-histogram/) | _O(n)_ | _O(n)_	| Hard | 🔍 <ul><li>__stack__: stack要保证height是由小变大的,当遇到新的height小于stack.top(),pop stack，算area.</li><li> __Divide Conquer__:最小的area来自左面，或者来自右面，或者来自area contain middle point</li></ul> |
