...
| [347. Top K Frequent Elements](https://leetcode.com/problems/top-k-frequent-elements/) | _O(n)_ | _O(n)_	| Medium | 😍🔍 Bucket Sort, Quick Select(n-th elements), priority_queue (maxheap: priority_queue, minheap: multiset) |
