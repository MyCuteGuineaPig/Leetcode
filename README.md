...
| [518. Coin Change 2](https://leetcode.com/problems/coin-change-2/)	|	_O(n^2)_	|	_O(n)_|	Medium | 👀👀经典TopDown, Bottom-up <br/>  类似的题: <ul><li>[279. Perfect Squares](https://leetcode.com/problems/perfect-squares/description/)</li><li> [322. Coin Change](https://leetcode.com/problems/coin-change/description/) </li><li>[377. Combination Sum IV](https://leetcode.com/problems/combination-sum-iv/description/)	</li><li>[983. Minimum Cost For Tickets](https://leetcode.com/problems/minimum-cost-for-tickets/)</li></ul>|
