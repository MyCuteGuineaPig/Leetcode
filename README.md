...
| [085. Maximal Rectangle	](https://leetcode.com/problems/maximal-rectangle/) | _O(n\*m)_ | _O(m)_	| Hard | __stack__:与[084. Largest Rectangle in Histogram](https://leetcode.com/problems/simplify-path/) 类似, matrix有n行，问题可以转换成n个Histogram的问题,每个问题就是一个以这一行为底的Histogram问题，上面连续的1的个数就是Height |
