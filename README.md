...
| [329. Longest Increasing Path in a Matrix](https://leetcode.com/problems/longest-increasing-path-in-a-matrix/description/)	| _O(m \* n)_ | _O(m \* n)_ | Hard | 😍 DFS + DP ✏️[C++ lambda function](https://github.com/beckswu/Leetcode/blob/master/DFS/329.%20Longest%20Increasing%20Path%20in%20a%20Matrix.cpp#L68) |
