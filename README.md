...
| [394. Decode String](https://leetcode.com/problems/decode-string/) | _O(n)_ | _O(h)_	| Medium | 🔍可以看看recursive 的解, **程序设计**: 怎么设计一个好的stack <ul><li>遇到num, push num 进num stack </li><li>遇到'\[',push “”进pat stack</li></ul> |
