...
| [187. Repeated DNA Sequences](https://leetcode.com/problems/repeated-dna-sequences/) | _O(n)_ | _O(n)_	| Medium | rolling hash (rabin-karp), <ul><li>A = 00, C = 01, G = 10, T = 11, 然后i大于9后 t>>2 & 0xfffff(2^18-1)做&运算</li><li>直接把A,C,G,T默认转化成ASCII，与&7, 后三位是unique的，i>9后做 t << 3 & 0x3FFFFFFF</li></ul> |
...
| [341. Flatten Nested List Iterator](https://leetcode.com/problems/flatten-nested-list-iterator/) | _O(n)_ | _O(h)_	| Medium | stack + recursion从最后往前loop, queue从前往后loop|
