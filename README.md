...
| [368. Largest Divisible Subset](https://leetcode.com/problems/largest-divisible-subset/)	|	_O(n^2)_	|	_O(n)_ |	Medium | 先sort，然后后面的大的，只要除以</br>subset中最大的数，就可以append</br>进subset,再用一个parent vector,放新放数得上一个数的位置 |
