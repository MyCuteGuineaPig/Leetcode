...
| [071. Simplify Path](https://leetcode.com/problems/simplify-path/) | _O(n)_ | _O(n)_	| Medium |  ✏️ `stringstream` + `getline` 可以处理连续的delimiter 比如delimiter是`/`, 可以parse`//c/d//` 为`c` 和`d`, `vectro<string>`的 join |
