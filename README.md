...
| [199	Binary Tree Right Side View](https://leetcode.com/problems/binary-tree-right-side-view/)	| _O(n)_	| _O(h)_	| Medium		 |  ❌ Easy  |
| [200	Number of Islands](https://leetcode.com/problems/number-of-islands/)	| _O(m \* n)_ |	_O(m \* n)_ |	Medium		|✏️ [Union Find with Rank Heuristics](https://github.com/beckswu/Leetcode/blob/master/DFS/200.%20Number%20of%20Islands.cpp#L161)  |
...
| [1367	Linked List in Binary Tree](https://leetcode.com/problems/linked-list-in-binary-tree/)	|	_O(n+l)_	|	_O(h+l)_ |	Medium |  |
| [1368	Minimum Cost to Make at Least One Valid Path in a Grid](https://leetcode.com/problems/minimum-cost-to-make-at-least-one-valid-path-in-a-grid/)	|	_O(m\*n|)_	|	_O(m\*n|)_ |	Hard | BFS + DFS |
...
| [126. Word Ladder II](https://leetcode.com/problems/word-ladder-ii/description/)	|	_O(n \* d)_	|	_O(d)_ |	Hard | two end pointer BFS 用DFS TLE ✏️[C++ std::function](https://github.com/beckswu/Leetcode/blob/master/Backtracking/140.%20Word%20Break%20II.cpp#L103) |
