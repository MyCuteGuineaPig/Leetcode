...
| [155. Min Stack](https://leetcode.com/problems/min-stack/) | _O(n)_ | _O(1)_	| Easy | 两个stack,一个用来放正常的顺序，另一个作为min stack用来存最小值，只有当新来的比minstack.top()还小(stk中的数是从小到大排序的)，再push，pop时候，如果普通stack.top() == minstack.top(),minstack也pop |
